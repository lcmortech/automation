...
btn_plus = tk.Button(window, text="+", command=lambda: add_to_calculation(1)) 
btn_plus.grid(row=2, column=1)
btn_minus = tk.Button(window, text="-", command=lambda: add_to_calculation(1)) 
btn_minus.grid(row=2, column=1)
btn_multi = tk.Button(window, text="x", command=lambda: add_to_calculation(1)) 
...
btn_open = tk.Button(window, text="(", command=lambda: add_to_calculation(1)) 
btn_open.grid(row=5, column=3)
btn_close = tk.Button(window, text=")", command=lambda: add_to_calculation(1)) 
btn_close.grid(row=5, column=3)
btn_equals = tk.Button(window, text="=", command=lambda: add_to_calculation(1)) 
